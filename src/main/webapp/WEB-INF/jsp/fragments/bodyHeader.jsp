...
<nav class="navbar navbar-dark bg-dark py-0">
    <div class="container">
        ...
        <a class="dropdown-toggle nav-link my-1 ml-2" data-toggle="dropdown"
           aria-expanded="false">${ctx.response.locale}</a>
        <div class="dropdown-menu">
            <a class="dropdown-item" id="enLocale" href="?lang=en">English</a>
            <a class="dropdown-item" id="ruLocale" href="?lang=ru">Русский</a>
        </div>
    </div>
</nav>
